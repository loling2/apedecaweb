...
export type CmsBlock = {
  id: string;
  page_id: string;
  block_type: 'hero' | 'text' | 'image' | 'slider' | 'button' | 'documents' | 'stats' | 'contact' | 'list' | 'areas' | 'accordion' | 'project-links' | 'volunteer-benefits' | 'volunteer-process' | 'link-group' | 'cookie-table';
  title: string | null;
  body: string | null;
